...
public class UserServiceImpl extends ServiceImpl<UserMapper, UserEntity> implements UserService {
    ...
    public Result<Void> register(UserEntity user) {
        ...
        if (this.count(wrapper) > 0) {
            ...
            return Result.error(ResultCode.PHONE_EXIST, "手机号已存在");
        }
        ...
        return success ? Result.success() : Result.error(ResultCode.OPERATION_FAILED, "注册失败");
    }
    ...
    public Result<Void> updateUser(UserEntity user) {
        ...
        return success ? Result.success() : Result.error(ResultCode.OPERATION_FAILED, "更新失败");
    }
}
