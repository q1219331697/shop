...
-- RBAC模型 - 角色表
-- =====================================================
-- changeset shop:1.1.0-create-admin-role-table context:admin
...
-- RBAC模型 - 权限表（菜单+按钮级）
-- =====================================================
-- changeset shop:1.1.0-create-admin-permission-table context:admin
...
-- RBAC模型 - 用户角色关联表
-- =====================================================
-- changeset shop:1.1.0-create-admin-user-role-table context:admin
...
-- RBAC模型 - 角色权限关联表
-- =====================================================
-- changeset shop:1.1.0-create-admin-role-permission-table context:admin
...
-- 修改管理员表：移除role字段
-- =====================================================
-- changeset shop:1.1.0-alter-admin-user-drop-role context:admin
ALTER TABLE t_admin_user DROP COLUMN role;
