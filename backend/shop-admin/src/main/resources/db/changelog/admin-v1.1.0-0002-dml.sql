...
-- 初始化角色数据
-- =====================================================
-- changeset shop:1.1.0-insert-role-data context:admin stripComments:false
...
-- 初始化权限数据 - 菜单
-- =====================================================
-- changeset shop:1.1.0-insert-permission-menu-data context:admin stripComments:false
...
-- 初始化权限数据 - 按钮
-- =====================================================
-- changeset shop:1.1.0-insert-permission-button-data context:admin stripComments:false
...
-- =====================================================
-- changeset shop:1.1.0-insert-super-admin-role-permission context:admin stripComments:false
...
-- 初始化角色权限关联 - 运营管理员
-- =====================================================
-- changeset shop:1.1.0-insert-operator-role-permission context:admin stripComments:false
...
-- 初始化角色权限关联 - 客服人员
-- =====================================================
-- changeset shop:1.1.0-insert-customer-service-role-permission context:admin stripComments:false
INSERT IGNORE INTO t_admin_role_permission (role_id, permission_id) VALUES
-- 订单管理菜单及按钮（只读）
(3, 3), (3, 30), (3, 300),
-- 用户管理菜单及按钮（只读）
...
-- 初始化用户角色关联
-- =====================================================
-- changeset shop:1.1.0-insert-user-role-data context:admin stripComments:false
