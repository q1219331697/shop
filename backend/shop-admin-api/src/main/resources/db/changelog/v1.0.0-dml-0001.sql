...
-- 订单管理（目录 + 列表页）
(1, 0, '订单管理', NULL, 1, '/order', 'Document', NULL, 1, 1, 1),
(101, 1, '订单列表', 'order:list', 2, '/order/list', 'List', 'views/order/list/index.vue', 1, 1, 1),
-- 商品管理（目录 + 列表页 + 分类页）
(2, 0, '商品管理', NULL, 1, '/product', 'Goods', NULL, 2, 1, 1),
(201, 2, '商品列表', 'product:list', 2, '/product/list', 'List', 'views/product/list/index.vue', 1, 1, 1),
(202, 2, '商品分类', 'product:category', 2, '/product/category', 'Menu', 'views/product/category/index.vue', 2, 1, 1),
-- 会员管理（目录 + 列表页，功能待开发）
(3, 0, '会员管理', NULL, 1, '/member', 'User', NULL, 3, 1, 1),
(301, 3, '会员列表', 'member:list', 2, '/member/list', 'List', 'views/member/list/index.vue', 1, 1, 1),
-- 系统管理（目录）
(4, 0, '系统管理', NULL, 1, '/system', 'Setting', NULL, 4, 1, 1),
-- 管理员管理（菜单 + 列表权限点 + 隐藏任务页 + 操作权限点）
(401, 4, '管理员管理', NULL, 2, '/system/admin', 'User', 'views/system/admin/index.vue', 1, 1, 1),
(40101, 401, '管理员列表', 'system:admin:list', 3, NULL, NULL, NULL, 1, 1, 1),
(40102, 401, '管理员详情', 'system:admin:detail', 2, '/system/admin/detail/:id', NULL, 'views/system/admin/AdminDetailPage.vue', 2, 0, 1),
(40103, 401, '新增管理员', 'system:admin:create', 2, '/system/admin/create', NULL, 'views/system/admin/AdminFormPage.vue', 3, 0, 1),
(40104, 401, '编辑管理员', 'system:admin:update', 2, '/system/admin/edit/:id', NULL, 'views/system/admin/AdminFormPage.vue', 4, 0, 1),
(40105, 401, '管理员删除', 'system:admin:delete', 3, NULL, NULL, NULL, 5, 1, 1),
(40106, 401, '分配角色', 'system:admin:assign-role', 2, '/system/admin/assign-role/:id', NULL, 'views/system/admin/AssignRolePage.vue', 6, 0, 1),
(40107, 401, '重置密码', 'system:admin:reset-password', 3, NULL, NULL, NULL, 7, 1, 1),
(40108, 401, '禁用管理员', 'system:admin:disable', 3, NULL, NULL, NULL, 8, 1, 1),
(40109, 401, '启用管理员', 'system:admin:enable', 3, NULL, NULL, NULL, 9, 1, 1),
(40110, 401, '恢复管理员', 'system:admin:restore', 3, NULL, NULL, NULL, 10, 1, 1),
-- 角色管理（菜单 + 列表权限点 + 隐藏任务页 + 操作权限点）
(402, 4, '角色管理', NULL, 2, '/system/role', 'UserFilled', 'views/system/role/index.vue', 2, 1, 1),
(40201, 402, '角色列表', 'system:role:list', 3, NULL, NULL, NULL, 1, 1, 1),
(40202, 402, '新增角色', 'system:role:create', 2, '/system/role/create', NULL, 'views/system/role/RoleFormPage.vue', 2, 0, 1),
(40203, 402, '编辑角色', 'system:role:update', 2, '/system/role/edit/:id', NULL, 'views/system/role/RoleFormPage.vue', 3, 0, 1),
(40204, 402, '角色删除', 'system:role:delete', 3, NULL, NULL, NULL, 4, 1, 1),
(40205, 402, '分配权限', 'system:role:assign', 2, '/system/role/assign-permission/:id', NULL, 'views/system/role/AssignPermissionPage.vue', 5, 0, 1),
(40206, 402, '禁用角色', 'system:role:disable', 3, NULL, NULL, NULL, 6, 1, 1),
(40207, 402, '启用角色', 'system:role:enable', 3, NULL, NULL, NULL, 7, 1, 1),
