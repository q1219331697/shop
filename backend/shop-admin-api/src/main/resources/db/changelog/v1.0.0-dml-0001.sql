...
(1006, 1001, '创建用户', 'system:user:create', 2, NULL, NULL, 'views/system/user/form.vue', 2, 1, 1, NOW(), NOW()),
(1007, 1001, '更新用户', 'system:user:update', 2, NULL, NULL, 'views/system/user/form.vue', 3, 1, 1, NOW(), NOW()),
(1008, 1001, '删除用户', 'system:user:delete', 2, NULL, NULL, 'views/system/user/index.vue', 4, 1, 1, NOW(), NOW()),
(1009, 1002, '角色列表', 'system:role:list', 2, '/system/role/list', NULL, 'views/system/role/index.vue', 1, 1, 1, NOW(), NOW()),
(1010, 1002, '创建角色', 'system:role:create', 2, NULL, NULL, 'views/system/role/form.vue', 2, 1, 1, NOW(), NOW()),
(1011, 1002, '更新角色', 'system:role:update', 2, NULL, NULL, 'views/system/role/form.vue', 3, 1, 1, NOW(), NOW()),
(1012, 1002, '删除角色', 'system:role:delete', 2, NULL, NULL, 'views/system/role/index.vue', 4, 1, 1, NOW(), NOW()),
(1013, 1003, '权限列表', 'system:permission:list', 2, '/system/permission/list', NULL, 'views/system/permission/index.vue', 1, 1, 1, NOW(), NOW()),
(1014, 1003, '创建权限', 'system:permission:create', 2, NULL, NULL, 'views/system/permission/form.vue', 2, 1, 1, NOW(), NOW()),
(1015, 1003, '更新权限', 'system:permission:update', 2, NULL, NULL, 'views/system/permission/form.vue', 3, 1, 1, NOW(), NOW()),
(1016, 1003, '删除权限', 'system:permission:delete', 2, NULL, NULL, 'views/system/permission/index.vue', 4, 1, 1, NOW(), NOW()),
