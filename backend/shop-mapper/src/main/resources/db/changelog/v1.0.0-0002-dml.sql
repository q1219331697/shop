...
INSERT IGNORE INTO t_category (name, description, sort, status) VALUES ('电子产品', '各类电子产品', 1, 1);
INSERT IGNORE INTO t_category (name, description, sort, status) VALUES ('服装鞋帽', '各类服装鞋帽', 2, 1);
INSERT IGNORE INTO t_category (name, description, sort, status) VALUES ('食品饮料', '各类食品饮料', 3, 1);
INSERT IGNORE INTO t_category (name, description, sort, status) VALUES ('家居用品', '各类家居用品', 4, 1);
INSERT IGNORE INTO t_category (name, description, sort, status) VALUES ('图书音像', '各类图书音像', 5, 1);

-- 插入商品数据
-- changeset shop:1.0.0-insert-product-data stripComments:false
INSERT IGNORE INTO t_product (name, description, price, stock, image, category_id, status, sales) VALUES
...
INSERT IGNORE INTO t_user (username, password, nickname, phone, email, status) VALUES
